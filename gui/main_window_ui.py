...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dict_file_lineEdit.setAccessibleName(QMainWindow.tr("dict_file", None))
        ...
        self.redirect_config_lineEdit.setAccessibleName(
            QMainWindow.tr("redirect_config", None)
        )
        # endif // QT_CONFIG(accessibility)
        ...
        self.alias_config_lineEdit.setAccessibleName(
            QMainWindow.tr("alias_config", None)
        )
        # endif // QT_CONFIG(accessibility)
        ...
        # if QT_CONFIG(accessibility)
        self.two_mora_checkBox.setAccessibleName(QMainWindow.tr("is_two_mora", None))
        # endif // QT_CONFIG(accessibility)
        self.two_mora_checkBox.setText(QMainWindow.tr("2 mora", None))
        # if QT_CONFIG(accessibility)
        self.haru_style_checkBox.setAccessibleName(
            QMainWindow.tr("is_haru_style", None)
        )
        # endif // QT_CONFIG(accessibility)
        self.haru_style_checkBox.setText(QMainWindow.tr("Haru.J style", None))
        # if QT_CONFIG(accessibility)
        self.mora_x_checkBox.setAccessibleName(QMainWindow.tr("is_mora_x", None))
        # endif // QT_CONFIG(accessibility)
        ...
        # if QT_CONFIG(accessibility)
        self.length_spinBox.setAccessibleName(QMainWindow.tr("length", None))
        # endif // QT_CONFIG(accessibility)
        self.length_label.setText(QMainWindow.tr("Length", None))
        # if QT_CONFIG(accessibility)
        self.cv_head_checkBox.setAccessibleName(QMainWindow.tr("is_cv_head", None))
        # endif // QT_CONFIG(accessibility)
        self.cv_head_checkBox.setText(QMainWindow.tr("CV head", None))
        # if QT_CONFIG(accessibility)
        self.full_cv_checkBox.setAccessibleName(QMainWindow.tr("is_full_cv", None))
        # endif // QT_CONFIG(accessibility)
        self.full_cv_checkBox.setText(QMainWindow.tr("Full CV", None))
        # if QT_CONFIG(accessibility)
        self.c_head_4_utau_checkBox.setAccessibleName(
            QMainWindow.tr("is_c_head_4_utau", None)
        )
        # endif // QT_CONFIG(accessibility)
        ...
        # if QT_CONFIG(accessibility)
        self.bpm_spinBox.setAccessibleName(QMainWindow.tr("bpm", None))
        # endif // QT_CONFIG(accessibility)
        self.bpm_label.setText(QMainWindow.tr("bpm", None))
        # if QT_CONFIG(accessibility)
        self.blank_beat_spinBox.setAccessibleName(QMainWindow.tr("blank_beat", None))
        # endif // QT_CONFIG(accessibility)
        self.blank_beat_label.setText(QMainWindow.tr("blank beat", None))
        self.save_path_label.setText(QMainWindow.tr("Save path: ", None))
        # if QT_CONFIG(accessibility)
        self.save_path_lineEdit.setAccessibleName(QMainWindow.tr("save_path", None))
        # endif // QT_CONFIG(accessibility)
        self.save_path_lineEdit.setText(QMainWindow.tr("./result", None))
        self.save_path_button.setText(QMainWindow.tr("Select", None))
        # if QT_CONFIG(accessibility)
        self.reclist_checkBox.setAccessibleName(QMainWindow.tr("do_save_reclist", None))
        # endif // QT_CONFIG(accessibility)
        self.reclist_checkBox.setText(QMainWindow.tr("reclist", None))
        # if QT_CONFIG(accessibility)
        self.oto_checkBox.setAccessibleName(QMainWindow.tr("do_save_oto", None))
        # endif // QT_CONFIG(accessibility)
        self.oto_checkBox.setText(QMainWindow.tr("oto", None))
        # if QT_CONFIG(accessibility)
        self.presamp_checkBox.setAccessibleName(QMainWindow.tr("do_save_presamp", None))
        # endif // QT_CONFIG(accessibility)
        self.presamp_checkBox.setText(QMainWindow.tr("presamp", None))
        # if QT_CONFIG(accessibility)
        self.vsdxmf_checkBox.setAccessibleName(QMainWindow.tr("do_save_vsdxmf", None))
        # endif // QT_CONFIG(accessibility)
        self.vsdxmf_checkBox.setText(QMainWindow.tr("vsdxmf", None))
        # if QT_CONFIG(accessibility)
        self.lsd_checkBox.setAccessibleName(QMainWindow.tr("do_save_lsd", None))
        # endif // QT_CONFIG(accessibility)
